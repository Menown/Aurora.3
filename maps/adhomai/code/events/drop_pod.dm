/datum/event/drop_pod
	...
	no_fake = 1
	var/turf/spawn_loc
	var/list/possible_bad_drops = list(/mob/living/simple_animal/hostile/hivebotbeacon, /mob/living/simple_animal/hostile/bear, /mob/living/simple_animal/hostile/carp, /mob/living/simple_animal/hostile/carp/shark,
